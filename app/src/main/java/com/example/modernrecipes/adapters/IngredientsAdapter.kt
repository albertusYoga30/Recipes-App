...
import com.example.modernrecipes.databinding.IngredientsRowLayoutBinding
import com.example.modernrecipes.models.ExtendedIngredient
import com.example.modernrecipes.util.Constants.Companion.BASE_IMAGE_URL
...
class IngredientsAdapter : RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.ingredientName.text = ingredientsList[position].name.toString()
            .replaceFirstChar {
