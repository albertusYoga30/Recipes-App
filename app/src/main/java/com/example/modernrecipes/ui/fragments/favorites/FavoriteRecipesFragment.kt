package com.example.modernrecipes.ui.fragments.favorites
...
import com.example.modernrecipes.adapters.FavoriteRecipesAdapter
import com.example.modernrecipes.databinding.FragmentFavoriteRecipesBinding
    ...
    override fun onCreateView(
        ...
        menuHost.addMenuProvider(object : MenuProvider {
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                if (menuItem.itemId == R.id.deleteAll_Favorite_RecipesMenu) {
